...
<details>
  ...
  <ol>
    <li>
      <a href="#about-the-project">About Prabhupedia Client Project</a>
      <ul>
...
This is a banking project including transaction with external providers . This project was developed with React Js , Tailwind with routing and hooks.

Here's why:
* Make sure to know the entire  development process of React
* Ensures that , I can develop react based project without impediments
...
1. Clone the repo
   ```sh
    https://github.com/rsrPrabhu/prabhupedia-client
   ```
