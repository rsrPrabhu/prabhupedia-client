...
import {
    Box,
    IconButton, InputBase, Typography, Select, MenuItem,
...
import { setMode, setLogout } from "state/index_state";
...
const Navbar = () => {
    ...
    return (<FlexBetween padding="1rem 6%" backgroundColor={alt} >
        <FlexBetween gap="1.75rem">
            ...
            {isNonMobileScreens && (
                <FlexBetween backgroundColor={neutralLight} borderRadius="9px" gap="3em" padding="0.1rem 1.5rem">
